...
class SpaceGroup {
 public:
  ...
  types::t_int operator() (const rVector3d &a, const rVector3d &b) const {
    return equivalent_by_symmetry(a,b,cell,point_op,trans);
  }
  types::t_int operator() (const Array<rVector3d> &a, const Array<rVector3d> &b) const {
    return equivalent_by_symmetry(a,b,cell,point_op,trans);
  }
  types::t_int operator() (const MultiCluster &a, const MultiCluster &b) const {
    return equivalent_by_symmetry(a,b,cell,point_op,trans);
  }
  types::t_int operator() (const Structure &a, const Structure &b) const {
    return equivalent_by_symmetry(a,b,cell,point_op,trans);
  }
};
...
void find_spacegroup(Array<rMatrix3d> *point_op, Array<rVector3d> *trans,
                      const rMatrix3d &cell,
                      const Array<rVector3d> &atom_pos, const Array<types::t_int> &atom_type);
