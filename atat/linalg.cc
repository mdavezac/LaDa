...
void extract_columns(Array2d<Real> *pa, const Array2d<Real> &b, const Array<int> &cols, int nb_cols) {
...
void extract_columns(Array2d<Real> *pa, const Array2d<Real> &b, const LinkedList<int> &cols_list, int nb_cols) {
  Array<int> cols;
...
void extract_elements(Array<Real> *pa, const Array<Real> &b, const Array<int> &cols, int nb_cols) {
  if (nb_cols==-1) {nb_cols=cols.get_size();}
  pa->resize(nb_cols);
  for (int i=0; i<nb_cols; i++) {
    if (cols(i)>=0) {
