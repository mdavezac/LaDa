...
namespace LaDa
{
  namespace CE
  {
    ...
    class Separables : public LaDa::Separable::Function< 
                                 std::vector< 
                                  LaDa::Separable::Summand<
                                     LaDa::Separable::BooleanBasis > > >
    {
        friend class SymSeparables;
        //! Type of the base.
        typedef LaDa::Separable::Function< std::vector< LaDa::Separable::Summand<
                                       LaDa::Separable::BooleanBasis > > > t_Base;
      public:
