...
namespace LaDa
{
  namespace CE 
  {
    ...
    bool operator==(MLCluster::Spin const &_a, MLCluster::Spin const &_b) 
    {
      ...
      if( not math::is_null(_a.pos(0)-_b.pos(0)) ) return false;
      if( not math::is_null(_a.pos(1)-_b.pos(1)) ) return false;
      return  math::is_null(_a.pos(2)-_b.pos(2));
    }
    ...
    bool compare( MLCluster const &_a, MLCluster const &_b )
    {
      ...
      LADA_ASSERT( math::is_null( (_a.origin.pos-_b.origin.pos).squaredNorm() ), 
