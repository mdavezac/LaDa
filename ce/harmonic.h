  ...
  namespace CE
  {
    namespace ConstituentStrain
    {
      ...
      namespace Harmonic
      {
        ...
        //!             - types::t_real operator()(const math::rVector3d& _k ) const
        ...
        class Base   
        {
          ...
          public:
            ...
            //! \param [in] _k reciprocal-space vector.
            types::t_real evaluate(const math::rVector3d &_k) const;
        ...
        class Cubic : public Base< Cubic >
        {
          ...
          private:
            //! Serializes a harmonic.
            template<class Archive> void serialize(Archive & _ar, const unsigned int _version)
              { _ar & boost::serialization::base_object< Base<Cubic> >(*this); };
        };
