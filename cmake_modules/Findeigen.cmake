...
if(EIGEN_FOUND) 
  file(WRITE ${PROJECT_BINARY_DIR}/lada_dummy.cc
        "#include <Eigen/Core>\n"  
        "#if not EIGEN_VERSION_AT_LEAST(3,0,0)\n"
        "#  error\n" 
        "#endif\n" )
  try_compile(is_eigen3  ${PROJECT_BINARY_DIR} ${PROJECT_BINARY_DIR}/lada_dummy.cc
              COMPILE_DEFINITIONS -I${eigen_INCLUDE_DIR} 
              CMAKE_FLAGS -DCMAKE_CXX_LINK_EXECUTABLE="echo" 
              OUTPUT_VARIABLES _is_eigen3)
  file(REMOVE ${PROBJECT_BINARY_DIR}/lada_dummy.cc)
endif(EIGEN_FOUND)
