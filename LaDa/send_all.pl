...
my @job = ( #["darwin krossover true", "none",       "none", 0, 50, 0.1, 10000, 0.0, "pop"] );
            ...
            #["darwin krossover full ", "none",       "none", 0,  5,  0.2, 10000000, 0.0, "pop"] );
            #["lamarck krossover terminator:15000", "GradientSA",       "one point", 0, 5,  0.2, 10000000, 0.0, "pop"],
            #["lamarck krossover terminator:15000", "GradientSA",       "one point", 0, 20,  0.1, 10000000, 0.0, "pop"],
            #["lamarck krossover terminator:15000", "GradientSA",       "one point", 0, 40,  0.1, 10000000, 0.0, "pop"],
            #["lamarck krossover terminator:15000", "GradientSA",       "one point", 0, 60,  0.1, 10000000, 0.0, "pop"],
            #["lamarck krossover terminator:15000", "GradientSA",       "one point", 0, 80,  0.1, 10000000, 0.0, "pop"],
            #["lamarck krossover terminator:15000", "GradientSA",       "one point", 0, 50,  0.1, 10000000, 0.0, "pop"],
            #["darwin krossover terminator:10000", "none",       "one point", 0, 20,  0.1, 10000000, 0.0, "pop"],
            #["darwin krossover terminator:10000", "none",       "one point", 0, 40,  0.1, 10000000, 0.0, "pop"],
            #["darwin krossover terminator:10000", "none",       "one point", 0, 60,  0.1, 10000000, 0.0, "pop"],
            #["darwin krossover terminator:10000", "none",       "one point", 0, 80,  0.1, 10000000, 0.0, "pop"],
            #["darwin krossover terminator:10000", "none",       "one point", 0, 120,  0.1, 10000000, 0.0, "pop"],
            #["darwin krossover terminator:10000", "none",       "one point", 0, 140,  0.1, 10000000, 0.0, "pop"] );
             ["multistart terminator:200000",  "TabooSA", "one point", 0, 100, 0.1, 10000000, 0.0, "pop"] );
            #["multistart terminator:20000000 PrintOffsprings repeat:1",  "none", "one point", 0, 100, 0.1, 10000000, 0.0, "pop"] );
            #["multistart terminator:200000",  "TabooSA",    "one point", 0, 100, 0.1, 10000000, 0.0, "pop"] );
...
my @prefixes = ("atoms:2_2_7", "atoms:2_2_8", "atoms:2_2_9" );
# 
