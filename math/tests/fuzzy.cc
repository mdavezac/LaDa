...
int main()
{
  ...
  LADA_DOASSERT(not le(LADA_FIRST, LADA_FIRST+LADA_SMALL), "unexpected le result.\n")
  LADA_DOASSERT(not le(LADA_FIRST, LADA_FIRST+LADA_SMALL, LADA_TOL), "unexpected le result.\n")
  LADA_DOASSERT(le(LADA_FIRST, LADA_FIRST+5), "unexpected le result.\n")
