...
namespace LaDa
{
  namespace math
  {
    ...
    types::t_unsigned start_random( types::t_unsigned _seed )
    {
      ...
      LADA_DO_NASSERT( not a.get(), "Could not start_random random number generator boost::mt11213b.\n" )
      details::generator = a;
      ...
      LADA_DO_NASSERT( not a.get(), "Could not start_random uniform distribution.\n" )
      details::uni_dist = b;
      ...
      LADA_DO_NASSERT( not a.get(), "Could not start_random random number "
    ...
    types::t_unsigned seed( types::t_unsigned _seed )
    {
      ...
      LADA_NASSERT( not details::generator.get(), "random number generator was not created" );
      if( not _seed ) _seed = (types::t_unsigned) std::time(0);
      details::generator->seed( static_cast<unsigned int>(_seed) );
      return _seed;
    }
    ...
    types::t_real rng() 
    {
      LADA_NASSERT( not details::rng.get(), "random number generator was not created" )
      return (*details::rng)();
    } 
    bool flip()
    {
