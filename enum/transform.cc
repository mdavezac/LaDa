...
#              endif
     ...
     {
       bool pure_translation_ = (     math::eq(op(0, 0), 1.0) 
                                  and math::eq(op(0, 1), 0.0) 
                                  and math::eq(op(0, 2), 0.0)
                                  and math::eq(op(1, 0), 0.0) 
                                  and math::eq(op(1, 1), 1.0) 
                                  and math::eq(op(1, 2), 0.0)
                                  and math::eq(op(2, 0), 0.0) 
                                  and math::eq(op(2, 1), 0.0) 
                                  and math::eq(op(2, 2), 1.0) );
