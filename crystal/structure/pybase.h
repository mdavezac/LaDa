...
#   ifdef LADA_CRYSTAL_MODULE
      ...
      static PyTypeObject* structureiterator_type();
      //! Creates a new structure.
      static PyStructureObject* new_structure();
      //! Creates a new structure with a given type, also calling initialization.
      static PyStructureObject* new_structure(PyTypeObject* _type, PyObject *_args, PyObject *_kwargs);
      //! Creates a deepcopy of structure.
      static PyStructureObject *copy_structure(PyStructureObject* _self, PyObject *_memo=NULL);
      //! Transforms a structure in-place, according to symop.
      static void itransform_structure( PyStructureObject* _self,
                                        Eigen::Matrix<types::t_real, 4, 3> const &_op );
      //! Checks type of an object.
      static inline bool check_structure(PyObject *_self)
        { return PyObject_TypeCheck(_self, structure_type()); }
      //! Checks type of an object.
      static inline bool checkexact_structure(PyObject *_self)
        { return _self->ob_type ==  structure_type(); }
      //! Checks type of an object.
      static inline bool check_structure(PyStructureObject *_self)
        { return PyObject_TypeCheck(_self, structure_type()); }
      //! Checks type of an object.
      static inline bool checkexact_structure(PyStructureObject *_self)
        { return _self->ob_type ==  structure_type(); }
#   else
      //! Returns pointer to structure type.
