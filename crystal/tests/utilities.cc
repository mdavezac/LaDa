...
int main()
{
  ...
  LADA_ASSERT( eq( zero_centered(matrix*rVector3d(0.1, 0.1, 0.1), matrix),
                   matrix * rVector3d(0.1,0.1,0.1)), "Did not center.\n" )
  LADA_ASSERT( eq( zero_centered(matrix*rVector3d(0.5, 0.1, 0.1), matrix),
                   matrix * rVector3d(-0.5,0.1,0.1)), "Did not center.\n" )
  LADA_ASSERT( eq( zero_centered(matrix*rVector3d(0.5-8.0*types::tolerance, 0.1, 0.1), matrix),
                   matrix * rVector3d(0.5-8.0*types::tolerance,0.1,0.1)), "Did not center.\n" )
  LADA_ASSERT( eq( zero_centered(matrix*rVector3d(1.5, 0.1, 0.1), matrix),
                   matrix * rVector3d(-0.5,0.1,0.1)), "Did not center.\n" )
  return 0;
}
