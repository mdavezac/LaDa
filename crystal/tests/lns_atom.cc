...
#  define LADA_XML "<Atom pos=\"0.5 -0.5 0.5\" type=\"hello\" site=\"-1\" freeze=\"x\"/>"
...
#  define LADA_XML2 "<Atom pos=\"0.5 -0.5 0.5\" type=\"hello\" site=\"1\" freeze=\"x\"/>"
...
#  define LADA_XML "<Atom pos=\"0.5 -0.5 0.5\" type=\"Au Pd\" site=\"-1\" freeze=\"x\"/>"
...
#  define LADA_DOASSERT_SITE LADA_DOASSERT(atom.site() == -1, "Wrong site index.\n");
#  define LADA_XML2 "<Atom pos=\"0.5 -0.5 0.5\" type=\"Au Pd\" site=\"1\" freeze=\"x\"/>"
#  define LADA_DOASSERT_SITE2 LADA_DOASSERT(atom.site() == 1, "Wrong site index.\n");
...
int main()
{
  ...
  atom.freeze() = AtomFreezeMixin::frozen::NONE;
  LADA_CLEAR_TYPE;
  ...
  LADA_DOASSERT(atom.freeze() == AtomFreezeMixin::frozen::X, "Could not reload freeze.\n");
  LADA_DOASSERT_TYPE
  LADA_DOASSERT_SITE
