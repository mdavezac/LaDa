...
namespace LaDa
{
  namespace Python
  {
    types::t_int which_site1( Eigen::Vector3d const &_pos, Crystal::Lattice const &_lat )
      { return Crystal::which_site( _pos, !_lat.cell, _lat.sites ); }
    types::t_int which_site2( Eigen::Vector3d const &_pos, Crystal::Structure const &_lat )
      { return Crystal::which_site( _pos, !_lat.cell, _lat.atoms ); }
    types::t_int which_site3( Eigen::Vector3d const &_pos,
