static PyMethodDef LADA_ATOM_NAME(methods)[] = {
    {"copy", (PyCFunction)LADA_ATOM_NAME(copy), METH_NOARGS, "Returns a deepcopy of the atom." },
    {"cast", (PyCFunction)LADA_ATOM_NAME(cast), METH_VARARGS,
    ...
    {"to_dict", (PyCFunction)LADA_ATOM_NAME(to_dict), METH_NOARGS,
                "Returns a dictionary with shallow copies of items." },
    {"__copy__", (PyCFunction)LADA_ATOM_NAME(shallowcopy), METH_NOARGS, "Shallow copy of an atom." },
    {"__deepcopy__", (PyCFunction)LADA_ATOM_NAME(deepcopy), METH_O, "Deep copy of an atom." },
    {"__getstate__", (PyCFunction)LADA_ATOM_NAME(getstate), METH_NOARGS, "Implements pickle protocol." },
    {"__setstate__", (PyCFunction)LADA_ATOM_NAME(setstate), METH_O, "Implements pickle protocol." },
    {"__reduce__", (PyCFunction)LADA_ATOM_NAME(reduce), METH_NOARGS, "Implements pickle protocol." },
    {NULL}  /* Sentinel */
};

PyTypeObject LADA_ATOM_NAME(type) = {
...
#   endif
    sizeof(LADA_ATOM_TYPE),         /*tp_basicsize*/
    0,                         /*tp_itemsize*/
    (destructor)LADA_ATOM_NAME(dealloc), /*tp_dealloc*/
    0,                         /*tp_print*/
    0,                         /*tp_getattr*/
    0,                         /*tp_setattr*/
    0,                         /*tp_compare*/
    (reprfunc)LADA_ATOM_NAME(repr), /*tp_repr*/
    0,                         /*tp_as_number*/
    0,                         /*tp_as_sequence*/
    0,                         /*tp_as_mapping*/
    0,                         /*tp_hash */
    0,                         /*tp_call*/
    0,                         /*tp_str*/
    LADA_ATOM_NAME(getattro),       /*tp_getattro*/
    LADA_ATOM_NAME(setattro),       /*tp_setattro*/
    0,                         /*tp_as_buffer*/
...
#       endif
    ...
    (traverseproc)LADA_ATOM_NAME(traverse),    /* tp_traverse */
    (inquiry)LADA_ATOM_NAME(gcclear),          /* tp_clear */
    0,		               /* tp_richcompare */
    offsetof(LADA_ATOM_TYPE, weakreflist), /* tp_weaklistoffset */
    0,		               /* tp_iter */
    0,		               /* tp_iternext */
    LADA_ATOM_NAME(methods),        /* tp_methods */
    0,                         /* tp_members */
    LADA_ATOM_NAME(getsetters),        /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
    0,                         /* tp_descr_get */
    0,                         /* tp_descr_set */
    0,                         /* tp_dictoffset, dictionary is not reached this way. Must be null. */
    (initproc)LADA_ATOM_NAME(init),    /* tp_init */
    0,                            /* tp_alloc */
    LADA_ATOM_NAME(new),               /* tp_new */
};
