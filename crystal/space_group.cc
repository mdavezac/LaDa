...
//     // while we have identity, check strides.
//     if(    ((PyArrayObject*)identity)->strides[0] != 3*sizeof(types::t_real) 
//         or ((PyArrayObject*)identity)->strides[1] != sizeof(types::t_real) )
//     {
//       Py_DECREF(identity);
//       LADA_PYERROR(InternalError, "Strides of internal numpy array are unexpected.");
//       return NULL;
//     }
