...
#   ifdef LADA_CRYSTAL_MODULE
      ...
      static PyTypeObject* hftransform_type();
      //! Creates a new hftransform with a given type, also calling initialization.
      static PyHFTObject* new_hftransform(PyTypeObject* _type, PyObject *_args, PyObject *_kwargs);
      //! Creates a deepcopy of hftransform.
      static PyHFTObject *copy_hftransform(PyHFTObject* _self, PyObject *_memo = NULL);
      ...
      static bool _init_hft( PyHFTObject* _self, 
