...
void extract_columns(Array2d<Real> *pa, const Array2d<Real> &b, const Array<int> &cols, int nb_cols=-1);
void extract_columns(Array2d<Real> *pa, const Array2d<Real> &b, const LinkedList<int> &cols_list, int nb_cols=-1);
void extract_column(Array<Real> *pa, const Array2d<Real> &b, int col);
void extract_row(Array<Real> *pa, const Array2d<Real> &b, int row);
void extract_elements(Array<Real> *pa,  const Array<Real> &b, const Array<int> &cols, int nb_cols=-1);
void extract_elements(Array<Real> *pa,  const Array<Real> &b, int first, int lastp1);
void extract_elements(Array<Real> *pa, int first_dest, const Array<Real> &b, int first, int lastp1);
