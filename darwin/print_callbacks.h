...
namespace LaDa
{
  ...
  namespace GA
  {
    ...
    template< class T_OBJECT >
      ...
      <
        boost::is_base_of< details::isPrintCallBack, T_OBJECT >,
        std::ostream
    ...
    template< class T_OBJECT >
      class PrintSignal : public details::isPrintSignal
      {
        public:
          //! Type of the object.
          typedef T_OBJECT t_Object;
    ...
    template< class T_OBJECT >
      typename boost::enable_if
      <
        boost::is_base_of< details::isPrintSignal, T_OBJECT >,
        std::ostream
      > :: type& operator<<( std::ostream& _s, const T_OBJECT& _o )
      {
        const T_OBJECT& _this = *static_cast<const T_OBJECT*>( &_o );
