...
#    define BIGINCREMENTTAG( tag ) tag + 10
#    define REQUEST_TAG( tag ) tag 
#    define COMMAND_TAG( tag ) BIGINCREMENTTAG( tag ) 
#    define ONTABOO_TAG1( tag ) BIGINCREMENTTAG( COMMAND_TAG( tag ) )
#    define ONTABOO_TAG2( tag ) INCREMENTTAG( ONTABOO_TAG1( tag ) )
#    define ONOBJECTIVE_TAG1( tag ) BIGINCREMENTTAG( ONTABOO_TAG2( tag ) )
#    define ONOBJECTIVE_TAG2( tag ) INCREMENTTAG( ONOBJECTIVE_TAG1( tag ) )
#    define ONGRADIENT_TAG1( tag ) BIGINCREMENTTAG( ONOBJECTIVE_TAG2( tag ) )
#    define ONGRADIENT_TAG2( tag ) INCREMENTTAG( ONGRADIENT_TAG1( tag ) )
#    define ONGRADIENT_TAG3( tag ) INCREMENTTAG( ONGRADIENT_TAG2( tag ) )
#    define ONWITHGRADIENT_TAG1( tag ) BIGINCREMENTTAG( ONGRADIENT_TAG3( tag ) )
...
#    define ONONEGRADIENT_TAG1( tag ) BIGINCREMENTTAG( ONWITHGRADIENT_TAG4( tag ) )
...
#    define ONHISTORY_TAG1( tag ) BIGINCREMENTTAG( ONONEGRADIENT_TAG4( tag ) )
#    define ONHISTORY_TAG2( tag ) INCREMENTTAG( ONHISTORY_TAG1( tag ) )
#    define ONHISTORY_TAG3( tag ) INCREMENTTAG( ONHISTORY_TAG2( tag ) )
#    define ONSTORE_TAG( tag ) BIGINCREMENTTAG( ONHISTORY_TAG3( tag ) )
#    define ONWAIT_TAG( tag ) BIGINCREMENTTAG( ONSTORE_TAG( tag ) )
#  endif
