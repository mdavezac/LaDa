    ...
    namespace Graph
    {
      namespace Evaluation
      {
        template<class T_GATRAITS, template< class > class T_BASE >
          void Farmer<T_GATRAITS, T_BASE> :: operator()( const t_Population &_pop,
        ...
        template<class T_GATRAITS, template< class > class T_BASE >
          void Bull<T_GATRAITS, T_BASE> :: operator()(const t_Population& _parents,
                                                      t_Population& _offspring)
          {
