...
//
#ifndef _LADA_GA_CHECKPOINTS_XCRYSDENANIM_H_
#define _LADA_GA_CHECKPOINTS_XCRYSDENANIM_H_
  ...
  namespace GA
  {
    namespace CheckPoint
    {
      ...
      template< class T_INDIVIDUAL >
        void xcrysden_anim( const T_INDIVIDUAL& _individual, const std::string& _filename, 
                            const GenCount& _age, const Crystal::Structure& _structure )
        {
          ...
          structure.print_xcrysden( file );
          file.close();
        };
      
      namespace Factory
      {
        //! A factory for creating an xcrysden animation of best result at each generation.
        template< class T_CHECKPOINT, class T_DARWIN >
          void xcrysden_anim( T_CHECKPOINT& _checkpoint,
                              ...
                              const Crystal::Structure& _structure )
          {
            ...
            (
              ...
              ( 
                 ...
                 boost::bind
                 ( 
                   &GA::CheckPoint::xcrysden_anim< t_Individual >,
      ...
      namespace AddressOf
      {
        //! Returns address of void LaDa::GA::CheckPoint::Factory::xcrysden_anim()
        template< class T_CHECKPOINT, class T_DARWIN >
          void (*xcrysden_anim( const T_CHECKPOINT&, const T_DARWIN& ))
            ( T_CHECKPOINT&, const std::string&, const T_DARWIN&, const Crystal::Structure& )
              { return &Factory::xcrysden_anim< T_CHECKPOINT, T_DARWIN >; }
      } // namespace AddressOf
    } // namespace CheckPoint
  } // namespace GA
} // namespace LaDa
