...
class RelaxCellShape(object):
  ...
  def generator(structure, outdir=None, comm=None, **kwargs ):
  ...
  def __call__(*args, **kwargs):
    """ Performs a vasp relaxation. 
        ...
        agument C{relaxation} as a shorthand for C{set_relaxation}.
        C{set_relaxation} takes precedence, however. 

        If you want to examine the result of each and every vasp calculation,
        use L{generator} instead.
    """ 
