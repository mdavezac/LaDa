...
Module Escan
  ...
  contains
    ...
    subroutine read_escaninput( filename, escan_input, mpicomm )
      ! input filename
      ...
      call mpi_bcast(escan_input%ecp%filepot, width, MPI_CHARACTER, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%ecp%filewg_out, width, MPI_CHARACTER, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%method, 1, MPI_INTEGER, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%ecp%Eref, 1, MPI_DOUBLE_PRECISION, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%Ecutoff, 1, MPI_DOUBLE_PRECISION, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%Gsmooth, 1, MPI_DOUBLE_PRECISION, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%KineticScaling, 1, MPI_DOUBLE_PRECISION, 0, mpicomm, ierr)
      call mpi_bcast(ikpt, 1, MPI_INTEGER, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%kpoint(1), 3, MPI_DOUBLE_PRECISION, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%lattice_scale, 1, MPI_DOUBLE_PRECISION, 0, mpicomm, ierr)
      call mpi_bcast(escan_input%PotentialType, 1, MPI_INTEGER, 0, mpicomm, ierr)
